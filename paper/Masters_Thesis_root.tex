...
This is then in contrast to traditional configuration workarounds exemplified by CVE-2021\-44228 where a series of vulnerabilities in the Java-based logging library Log4J were under active exploitation. Exploitation of one of these vulnerabilities allowed an unauthenticated attacker to perform remote code execution on a server. This means that some attacker could run arbitrary malicious code to either deploy additional malware or steal data.
